              ...
              <div className={styles.colCard}>
                <div className={`${styles.item} ${styles.alignBox}`}>
                  <div>
                    ...
                    <p className={styles.mb5}>
                      Our Managed contests combine the power of crowdsourcing
                      with the rich experience of our branding consultants. Get
                      a complete agency-level experience at a fraction of Agency
                      costs
                    </p>
                  </div>
                  <div className={styles.mb3}>
