  ...
  return (
    <div
      className={classNames(styles.offerContainer, {
        [styles.approvedOffer]:
          role === CONSTANTS.CREATOR && data.isApproved === true,
        [styles.rejectedOffer]:
          role === CONSTANTS.CREATOR && data.isApproved === false,
      })}
    >
      {role === CONSTANTS.CREATOR && data.isApproved !== null && (
        <div
          className={classNames(styles.approvalBadge, {
            [styles.approved]: data.isApproved === true,
            [styles.rejected]: data.isApproved === false,
          })}
        >
          {data.isApproved ? 'Approved by Moderator' : 'Rejected by Moderator'}
        </div>
      )}
      {offerStatus()}
